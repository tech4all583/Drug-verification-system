...
(function(theme, $) {
	...
	PluginLightbox.defaults = {
		...
		gallery: {
			...
			tCounter: '%curr% of %total%' ../../https/markup for_2132835864.html "1 of 7" counter
		},
		image: {
	...
	$.extend(theme, {
		...
		PluginValidation: {
			...
			defaults: {
				...
				validateCaptchaURL: 'php/contact-form-verify-captcha_php.html',
				refreshCaptchaURL: 'php/contact-form-refresh-captcha_php.html'
			},
